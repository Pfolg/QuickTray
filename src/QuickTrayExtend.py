...
class EWidget(QWidget):
    def __init__(self, p=None):
        ...
        self._string_choose = "回车选择"
        self._string_add = "添加"
        self._string_update = "刷新"
        self._string_open = "打开"
        self._string_sentence = "输入语句"
        self._string_change = "更改"
        self._string_warning_empty_input = "输入为空，无可添加内容！"
        self._string_information_add_success = "添加成功！"
